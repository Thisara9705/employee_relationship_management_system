...
<nav class="w3-sidebar w3-collapse w3-white " style="z-index:3;width:250px;" id="mySidebar"><br>
  <div class="w3-container w3-row" style="margin-top:20px;">
    <div class="w3-col s4">
  ...
  <div class="w3-sidebar" style="width:250px;">
    ...
    <a href="index.php" class="w3-bar-item w3-button" style="font-size:14px; padding-top:5px; text-decoration:none; color:black;"><i class="fa fa-dashboard"></i>  Dashboard</a>
    ...
    <a href="eto.php" class="w3-bar-item w3-button " style="font-size:14px; padding-top:5px; text-decoration:none; color:black;"><i class="fa fa-exclamation-triangle"></i>  Possible ETO List</a><br>

    <a href="carder.php" class="w3-bar-item w3-button " style="font-size:14px; padding-top:5px; text-decoration:none; color:black;"><i class="fa fa-bar-chart"></i>  Carder Report</a><br>

    <a href="oldcarder.php" class="w3-bar-item w3-button " style="font-size:14px; padding-top:5px; text-decoration:none; color:black;"><i class="fa fa-bar-chart"></i>  Old Carder Reports</a><br>
    ...
    <a href="add_acarder.php" class="w3-bar-item w3-button " style="font-size:14px; padding-top:5px; text-decoration:none; color:black;"><i class="fa fa-line-chart "></i>  Add Actual Carder</a><br>

    <a href="carder_status.php" class="w3-bar-item w3-button " style="font-size:14px; padding-top:5px; text-decoration:none; color:black;"><i class="fa fa-user-plus "></i> Carder Status</a><br>
