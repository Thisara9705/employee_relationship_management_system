    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped" id="table">
            ...
            <?php
                ...
                $count = 1;
                $date = $_GET['date'];
                $all = $db->query("SELECT DISTINCT e.Team,e.Name,a.PN,e.EPF,t.Area,a.Date_To,a.Reason FROM emp e INNER JOIN team t ON e.Team=t.Team INNER JOIN attendance a ON e.PN=a.PN  WHERE  Reason IN ('C1','Symptoms','Positive') AND Date_To='$date' AND Area IN ('A-Thilina','A-Chanuka','B-Thilina','B-Chanuka') AND DATE(a_date) = CURDATE() AND DATE(Entered_date) = CURDATE()");
