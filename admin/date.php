...
<!-- Header -->
    <header class="w3-container" style="padding-top:22px">
        <h3><b><i class="fa fa-bar-chart"></i> <?php echo $_GET['date']; ?> Carder Repoart</b></h3>
    </header>
...
<div class="w3-row-padding w3-margin-bottom">
        <div class="w3-half" style="margin-bottom:10px;">
            <a href="old_area.php?date=<?php echo $_GET['date']; ?>" style="text-decoration:none; color:white;">
        ...
        <div class="w3-half" style="margin-bottom:10px;">
            <a href="old_team.php?date=<?php echo $_GET['date']; ?>" style="text-decoration:none; color:white;">
            <div class="w3-container w3-red  w3-margin-16 w3-padding-16 w3-animate-zoom " >
