...
<!-- Header -->
    <header class="w3-container" style="padding-top:22px">
        <h3><b><i class="fa fa-bookmark"></i> Departments</b></h3>
    </header>
...
<div class="w3-row-padding w3-margin-bottom">
        ...
        <?php
            ...
            $all = $db->query("SELECT e.Team,t.Area,a.Attendance,t.Shift,COUNT(DISTINCT a.PN) attendance_count FROM emp e INNER JOIN team t ON e.Team=t.Team INNER JOIN attendance a ON e.PN=a.PN WHERE Area='Departments' AND Attendance='absent' AND DATE(a_date) = CURDATE() AND DATE(Entered_date) = CURDATE() GROUP BY Team;");
