...
<!--======================================Prasanna-A-Shift==============================================-->
            ...
            <?php
                $all = $db->query("SELECT id FROM team WHERE  VSL='Prasanna'  AND DATE(c_date) = CURDATE()");
                ...
                foreach($fetch as $data){
                    ...
                    pc.date_count,pc.date_count1,pc.date_count2,pc.date_count3,pc.date_count4 
            ...
            <tr>
                ...
                <td><?php echo $data->date_count ?></td>
                <td><?php echo $data->date_count1 ?></td>
                <td><?php echo $data->date_count2 ?></td>
                <td><?php echo $data->date_count3 ?></td>
                <td><?php echo $data->date_count4 ?></td>
            ...
            <tr class='w3-light-blue'>
                ...
                <td><?php echo $total_datecount ?></td>
                <td><?php echo $total_datecount1 ?></td>
                <td><?php echo $total_datecount2 ?></td>
                <td><?php echo $total_datecount3 ?></td>
                <td><?php echo $total_datecount4 ?></td>
...
<?php
            ...
            <tr class='w3-light-blue'>
                ...
                <td><?php echo 'Sanjeewa A Shift' ?></td>
                <td><?php echo $total_ica ?></td>
                <td><?php echo $total_ac ?></td>
                <td><?php echo $total_ml ?></td>
                <td><?php echo $total_mli ?></td>
