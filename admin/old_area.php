...
<div class="w3-main" style="margin-left:250px;margin-top:30px;">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped" id="table3" style='font-weight: 700; font-size:7px;'>
            <thead>
                <tr>
                    <th>Area</th>
...
<!--=======================================Total-Production-Floor======================================-->
            ...
            <?php
                $a_date = $_GET['date'];
                $all = $db->query("SELECT id FROM team WHERE c_date='$a_date' AND Area IN ('A-Thilina','A-Chanuka','B-Thilina','B-Chanuka') OR  c_date='$a_date' AND Team IN ('Elastic Hub - SY','Supreme Operators - SY','Standing Jumpers - SY') ");
                $fetch = $all->fetchAll(PDO::FETCH_OBJ);
                $total_ica=0;
                $total_ac=0;
                $total_ml=0;
